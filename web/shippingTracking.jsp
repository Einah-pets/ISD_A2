...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form >
                 <label class="labelTracking">Enter your Order Number: 
                    <input class="input" type="text" placeholder="" name="CusOrderNum" required="true">
                </label>
                
                <a class=" btn-primary nav-link" style="max-width:85px; color:white; border-radius: 5px "href="shippingTrackingStatus.jsp">Submit</a>
