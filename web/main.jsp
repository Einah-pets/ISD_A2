                  ...
                  <a class="nav-link" href="AccessLogViewServlet">Access Log</a>
                    ...
                    <li class="nav-item">
                        <form action="AddProduct.jsp" method="POST">
                            <input type="submit" class="btn btn-light" value="Add Product">
                        </form>
                    </li>
              
                    <li class="nav-item">
                        <form action="StaffCatalogue.jsp" method="POST">
                            <input type="submit" class="btn btn-light" value="Edit Catalogue">
                        </form>
                    </li> 
