<%-- 
    Document   : shippingTracking
    Created on : 14/05/2022, 4:09:40 PM
    Author     : AlineStamboulian
--%>

<%--
    Users to enter their order number to track. 
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <br>
            <form method="post" action="shippingTrackingStatus.jsp">
               
            </form>
                        
            
            <form action="ShippingTrackingServlet" method="POST">
                 <label class="label">Enter your Order Number: 
                    <input class="input" type="text" placeholder="" name="CusOrderNum" required="true">
                </label>
               <button class="btn btn-primary" type="submit" href="shippingTrackingStatus.jsp">Submit</button>
